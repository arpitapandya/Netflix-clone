...
describe("<Header />", () => {
    it("renders the basic <Header /> with a background", () => {
        const { container, getByText, getByTestId } = render(
            <Header>
                <Header.Frame>
                    <Header.Log src="/logo.svg" alt="Netflix" />
    ...
    it("renders the full <Header /> with a background", () => {
        ...
        <Header src="joker1" dontShowOnSmallViewPort>
            ...
            <Header.Group>
                ...
                <Header.Profile>
                <Header.Picture src="/images/arpita.png" />
                <Header.Dropdown>
                    <Header.Group>
                    <Header.Picture src="/images/arpita.png" />
                    <Header.TextLink>Arpita Pandya</Header.TextLink>
                    </Header.Group>
                    <Header.Group>
        ...
        expect(getByText("Arpita Pandya")).toBeTruthy();
